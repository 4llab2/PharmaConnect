...
class DashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_accueil_pharmacie)
        ...
        btnProduits.setOnClickListener {
            startActivity(Intent(this, Produit_pharmacie::class.java))
            slide()
        }

        btnTraitement.setOnClickListener {
            startActivity(Intent(this, Traitement_commende::class.java))
            slide()
        }

        btnProfil.setOnClickListener {
            startActivity(Intent(this, Pharmacie_Profile::class.java))
            slide()
        }
